  ...
  return (
    <div className='p-6 flex flex-col gap-6'>
      <form
        ...
        autoComplete='off'
      >
        <label className='text-xs text-[#bdbdbd] block text-left'>OpenRouter API Key</label>
        <div className='flex items-center gap-2'>
          <input
            type={showKey ? 'text' : 'password'}
            value={inputValue}
            onChange={e => setInputValue(e.target.value)}
            className='px-3 py-2 rounded-md border border-[#232228] bg-[#232228] text-white focus:outline-none focus:ring-2 focus:ring-pink-400 transition text-sm w-full max-w-md'
          ...
          <button
            ...
            className='p-2 rounded-md border border-[#232228] bg-[#232228] text-[#bdbdbd] hover:text-[#DC749E] transition'
          ...
          <button
            type='submit'
            className='p-2 rounded-md border border-[#232228] bg-[#232228] text-[#bdbdbd] hover:text-[#DC749E] transition flex items-center gap-1'
      ...
      <div className='flex items-center gap-3 mt-4'>
        ...
        />
        <label htmlFor='use-own-key-switch' className='text-sm text-[#bdbdbd] cursor-pointer flex items-center gap-2'>
          Use my own OpenRouter API key for requests
        </label>
      </div>
      <div className='text-xs text-[#bdbdbd] mt-2 max-w-lg'>
