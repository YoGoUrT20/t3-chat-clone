...
export function DropdownControlled({ items, value, onChange, placeholder = 'Select', leftIcon, isOpen, setIsOpen, anchorRef, hideButton }) {
  const [hoveredIndex, setHoveredIndex] = React.useState(null)
  ...
  useClickAway([menuRef, anchorRef], () => setIsOpen(false))
  ...
  return (
    <MotionConfig reducedMotion="user">
      <div className="w-full px-0 relative" style={{ maxWidth: "16rem", height: "40px" }}>
        {!hideButton && (
          <Button
            variant="outline"
