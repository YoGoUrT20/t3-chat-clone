                    ...
                    <div className='flex-1 flex flex-col items-start justify-start pt-6 pl-2 pr-2 md:pt-10 md:pl-8 md:pr-8 relative w-full'>
                        ...
                        <div className='w-full mt-4 md:mt-8 min-h-[200px] md:min-h-[300px] min-w-0 md:min-w-[350px] rounded-xl shadow border border-[#ececec] dark:border-[#232228] flex flex-col transition-none bg-transparent'>
                            ...
                            <div className='prose prose-pink prose-tos max-w-full md:max-w-5xl w-full mx-auto p-2 md:p-4 dark:prose-invert prose-pre:m-0 prose-pre:bg-transparent prose-pre:p-0'>
                                <h1 className='text-2xl md:text-4xl font-black mb-6 md:mb-8 text-[#FAF7FD]'>QUIVER SECURITY POLICY</h1>
                                <div className='text-[#FAF7FD] mb-6 md:mb-10 text-sm md:text-base'>Last Updated: 2025-06-18</div>
                                ...
                                <h2 className='text-base md:text-lg font-bold mb-3 md:mb-4 text-[#FAF7FD]'>2. Reporting Security Issues</h2>
                                <ul className='space-y-2 md:space-y-3 pl-2 w-full'>
                                    <li className='flex items-start'>
                                        <span className='text-[#F2EBFA] flex-1 max-w-full md:max-w-5xl leading-7 md:leading-8' style={{ wordBreak: 'break-word' }}>
                                            ...
                                            <ul className='pl-6 mt-2 space-y-2'>
                                                <li className='flex items-start'>
                                                    <span className='text-[#DC749E] text-lg md:text-xl leading-7 mr-2 select-none flex-shrink-0'>&bull;</span>
                                ...
                                <h2 className='text-base md:text-lg font-bold mb-3 md:mb-4 text-[#FAF7FD]'>3. How We Protect Your Data</h2>
                                <ul className='space-y-2 md:space-y-3 pl-2 w-full'>
                                    <li className='flex items-start'>
                                        <span className='text-[#DC749E] text-xl md:text-2xl leading-8 mr-2 md:mr-3 select-none flex-shrink-0'>&bull;</span>
                                        <span className='text-[#F2EBFA] flex-1 max-w-full md:max-w-5xl leading-7 md:leading-8' style={{ wordBreak: 'break-word' }}>
                                ...
                                <h2 className='text-base md:text-lg font-bold mb-3 md:mb-4 text-[#FAF7FD]'>4. Your Responsibilities</h2>
                                <ul className='space-y-2 md:space-y-3 pl-2 w-full'>
                                    <li className='flex items-start'>
                                        <span className='text-[#F2EBFA] flex-1 max-w-full md:max-w-5xl leading-7 md:leading-8' style={{ wordBreak: 'break-word' }}>
                                            ...
                                            <ol className='pl-6 mt-2 space-y-2 list-decimal'>
                                                <li className='flex items-start'>
                                                    <span className='text-[#DC749E] text-base md:text-xl leading-7 mr-2 select-none flex-shrink-0'>1.</span>
                                                    <span className='text-[#F2EBFA] flex-1 leading-7' style={{ wordBreak: 'break-word' }}>
                                                        Use a strong password and don&apos;t share it with anyone.
                                                    </span>
                                                </li>
                                                <li className='flex items-start'>
                                                    <span className='text-[#DC749E] text-base md:text-xl leading-7 mr-2 select-none flex-shrink-0'>2.</span>
                                                    <span className='text-[#F2EBFA] flex-1 leading-7' style={{ wordBreak: 'break-word' }}>
                                                        Log out when you&apos;re done, especially on shared devices.
                                                    </span>
                                                </li>
                                                <li className='flex items-start'>
                                                    <span className='text-[#DC749E] text-base md:text-xl leading-7 mr-2 select-none flex-shrink-0'>3.</span>
                                                    <span className='text-[#F2EBFA] flex-1 leading-7' style={{ wordBreak: 'break-word' }}>
